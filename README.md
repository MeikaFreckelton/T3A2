# README - Dot Developer

## Purpose of the website

The purpose of this application is to provide a welcoming environment for developers to put themselves out there and connect with other developers, as well as potential employers. It simplifies the process of employers finding a suitable person to fit any specific role, by being able to filter through the profiles of users based on the skills and experience needed. Additionally, it is also a platform where developers can share their ideas through public blog posts to further develop their profiles and their presence on the site, as well as for other users to view and connect with and for potential employers to gain an even better understanding of the developer. This platform will seek to act as both a platform for respective employers to seek individuals as well as a place for developers to socialize in a community that is specific to software development. 
...
- Aspirational Developers 

- Junior, Mid, Senior Developers

- Businesses / Companies interested in Developers.

- Developers should live in Australia to get the most utility out of Dot Dev, but for blog related purposes this is completely flexible. 
  ...
  -  Understanding of market challenges and getting themselves out there for job opportunities. 

  - Contribute to a community that they love. 

  - Aspirational about blogging or helping out other developers.
    ...
    - Trouble engaging the community and prospective employee’s 
    - Referrals and peer support being crucial factors in business growth, allowing them to access a target market. 
...
Netlify will handle all of our client side code. After deploying to Heroku our front end react will make request to our express API handled on Heroku. Assuming that our application is connected ioaZto mongoDB, Heroku and Netlify are great choices that work synchronously to host your application to users.
...
![mobile-wires-1](docs/wireframes/mobile/boards/mobile-wireframes-1.png)

![mobile-wires-2](docs/wireframes/mobile/boards/mobile-wireframes-2.png)

![mobile-wires-3](docs/wireframes/mobile/boards/mobile-wireframes-3.png)

## Wireframes - tablet

![tablet-wires-1](docs/wireframes/tablet/boards/wireframes1.png)

![tablet-wires-2](docs/wireframes/tablet/boards/wireframes2.png)

![tablet-wires-3](docs/wireframes/tablet/boards/wireframes3.png)

## Wireframes - desktop

![desktop-wire](docs/wireframes/desktop/boards/wire1.png)

![desktop-wire](docs/wireframes/desktop/boards/wire2.png)

![desktop-wire](docs/wireframes/desktop/boards/wire3.png)

![desktop-wire](docs/wireframes/desktop/boards/wire4.png)
...
![](docs/trello-screenshots/trello-week2.png)

#### End of week 3:

![](docs/trello-screenshots/trello-week3.png)
